      ...
      <div className="bg-gradient-to-r from-[#30A08B] via-[#B2905F] to-[#B17236] text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="mt-2 text-lg opacity-90">
            {likedProducts.length} produits dans votre collection
          </p>
        </div>
      </div>
          ...
          {likedProducts.map((product, index) => (
            ...
            >
              <div className="relative group cursor-pointer">
                ...
                <div
                  className={`absolute inset-0 bg-black bg-opacity-50 transform transition-transform duration-700 group-hover:scale-110 flex items-center justify-center gap-4 transition-opacity duration-300 ${
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex justify-between items-center">
                  <span className="text-xl font-bold text-[#B17236]">
                    {product.price} FCFA
                  </span>
                  <button
      ...
      {likedProducts.length === 0 && (
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="mt-2 text-gray-500">
            Découvrez notre collection et commencez à créer votre liste de
            favoris
          </p>
          <button
