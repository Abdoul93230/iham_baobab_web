...
export default function BoutiquierProfile({ acces }) {
  ...
  const boutiquier = {
    ...
    photo:
      "https://plus.unsplash.com/premium_photo-1669343628944-d0e2d053a5e8?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW5zdGFncmFtJTIwcHJvZmlsZXxlbnwwfHwwfHx8MA%3D%3D",
    adresse: "Rue Ranavalona, Antananarivo, Madagascar",
    telephone: "+261 34 XX XX XX",
    email: "marie.artisan@example.com",
    description:
      "Artisan passionnée de mode malgache, je crée des vêtements et accessoires uniques qui célèbrent notre patrimoine culturel.",
    note: 4.7,
    totalProduits: 42,
    followers: 256,
    categoriesProduits: [
    ...
    informationsDetaillees: {
      ...
      politique:
        "Remboursement possible sous 14 jours, article non utilisé et dans son état original.",
    ...
    produits: [
      {
        ...
        prix: 129.99,
        image:
          "https://ae-pic-a1.aliexpress-media.com/kf/S711d4e9bd7d54ee0be1500b1d8966600x.jpg_480x480.jpg_.webp",
        note: 4.8,
      },
      {
        id: 2,
    ...
    avis: [
      {
        ...
        date: "2024-02-15",
        commentaire:
          "Une robe absolument magnifique ! La qualité est exceptionnelle et le design unique. Je recommande vivement.",
        likes: 12,
        dislikes: 0,
      },
      {
        ...
        date: "2024-01-20",
        commentaire:
          "Très bon artisan. Le sac que j'ai acheté est très bien confectionné. Petit bémol sur le délai de livraison.",
        likes: 5,
        dislikes: 2,
      },
      {
        ...
        date: "2024-03-10",
        commentaire:
          "Fière de soutenir l'artisanat local. Chaque pièce raconte une histoire et transmet notre culture.",
        likes: 8,
        dislikes: 1,
      },
    ],
  ...
  const renderStars = (rating, interactive = false) => {
    return [...Array(5)].map((_, index) => (
      <Star
        ...
        size={20}
        onClick={() =>
          interactive && setNewReview({ ...newReview, note: index + 1 })
        }
  ...
  const renderReviews = () => {
    ...
    return (
      <div className="space-y-4 mb-3">
        ...
        {reviews.map((avis) => (
          <div key={avis.id} className="bg-white p-4 rounded-xl shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span>
                Inscrit depuis le{" "}
                {new Date(
                  informationsDetaillees.dateInscription
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md">
              ...
              {/* Section Infos */}
              {activeSection === "infos" && (
                <div className="p-6">{renderInfoSection()}</div>
              )}

              {/* Section Avis */}
              {activeSection === "avis" && (
                <div className="p-6">{renderReviews()}</div>
              )}
            </div>
          </div>
