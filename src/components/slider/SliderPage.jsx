    ...
    <div className="mx-auto p-2 relative">
      ...
      >
        {products.map((product) => (
          ...
          >
            {product.prixPromo > 0 && (
              <div className="absolute z-2 right-3 top-2 bg-[#62aca2bb] py-1 rounded-full h-5 text-sm px-2   text-xs font-bold  text-white justify-center items-center flex">
                -{" "}
                {Math.round(
            ...
            <div className="flex flex-col w-full h-auto transition-transform transform hover:scale-105">
              ...
              <div className="mt-auto text-center shadow-sm bg-white">
                <h2 className="text-lg font-semibold text-[#30A08B]">
                  {product.name.slice(0, 10)}...
                </h2>
                <p className="text-md text-[#B2905F]">
