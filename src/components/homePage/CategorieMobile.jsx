  ...
  const categories = [
    {
      id: 1,
      name: "Électronique",
      icon: "https://res.cloudinary.com/mozillion/image/upload/f_auto,q_auto/v1662630077/bre0l08s9acswuaetx73.png",
      bgColor: "#30A08B",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      name: "Vêtements et accessoires sport",
      icon: "https://res.cloudinary.com/mozillion/image/upload/f_auto,q_auto/v1662630077/bre0l08s9acswuaetx73.png",
      bgColor: "#B17236",
    },
    {
    ...
    {
      id: 6,
      name: "Automobiles, pièces et accessoires",
      icon: "https://res.cloudinary.com/mozillion/image/upload/f_auto,q_auto/v1662630077/bre0l08s9acswuaetx73.png",
      bgColor: "#B17236",
    },
    {
  ...
  return (
    <div className=" w-full bg-gradient-to-b from-gray-50 to-white rounded-lg py-4 shadow-sm">
      ...
      `}
                >
                  <div
                    className={`rounded w-[80px] h-[50px] mb-2 transform transition-all duration-300 hover:shadow-md hover:scale-105 group relative overflow-hidden`}
                  >
                    <img
                      src={category.image}
                      alt={category.name}
