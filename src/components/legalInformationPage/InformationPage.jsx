...
const InformationPage = () => {
  ...
  const data = [
    ...
    { titre: '2. Conditions générales d\'utilisation (CGU) :', description: "Bienvenue sur Chagona-ne.onrender.com. En utilisant ce site, vous acceptez nos CGU et notre politique de confidentialité." },
  ...
  return (
    <div className="flex flex-col items-center bg-white p-6">
      <h1 className="text-3xl font-bold text-[#B17236] mb-6 text-center">Informations légales :</h1>
      <div className="bg-gray-100 p-4 rounded-lg shadow-md mb-6 w-full max-w-3xl">
        <h2 className="text-xl font-bold text-[#30A08B]">1 Mentions légales :</h2>
        <p className="text-black">HabouCom SARL</p>
        <p className="text-black">Niamey/Niger/Bobiel</p>
        <p className="text-black">Chagona-ne@gmail.com</p>
